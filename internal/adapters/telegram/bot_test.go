...
func TestRegisterCommands(t *testing.T) {
	...
	f := calls[0].form
	cmds := f.Get("commands")
	for _, name := range []string{`"command":"screen"`, `"command":"keys"`, `"command":"focus"`, `"command":"clear"`, `"command":"compact"`, `"command":"usage"`, `"command":"model"`, `"command":"status"`, `"command":"help"`} {
